					...
					<div style="display:block;padding:5px;">
						...
						<div style="display:block;border:solid 1px #CCC;padding:5px;" id="calc_submit">
							...
							<div class="form-group" style="margin:0px;margin-bottom:5px;">
								...
								<div class="col-md-3 col-xs-6"><button type="button" name="can_btn" id="can_btn" class="btn btn-danger" style="width:100%;" onclick="location.href='sale'"><div><span class="glyphicon glyphicon-trash"></span></div><div>취소 (F6)</div></button></div>
